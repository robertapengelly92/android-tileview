...
import  robertapengelly.support.tileview.detail.DetailLevelManager;
import  robertapengelly.support.tileview.geom.CoordinateTranslater;
...
import  robertapengelly.support.tileview.hotspot.HotSpot;
import  robertapengelly.support.tileview.hotspot.HotSpotManager;
 ...
 * }</pre>
 */
public class TileView extends ZoomPanLayout implements DetailLevelManager.DetailLevelChangeListener,
    TileCanvasViewGroup.TileRenderListener, ZoomPanLayout.ZoomPanListener {
    ...
    private MarkerLayout mCalloutLayout, mMarkerLayout;
    ...
    public TileView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mCalloutLayout = new MarkerLayout(context);
     ...
     * @param anchorX The x-axis position of a callout view will be offset by a number equal to the width of the callout
     *                view multiplied by this value.
     * @param anchorY The y-axis position of a callout view will be offset by a number equal to the height of the callout
     *                view multiplied by this value.
     *
    ...
    public View addCallout(View view, double x, double y, Float anchorX, Float anchorY) {
        return mCalloutLayout.addMarker(view, mCoordinateTranslater.translateX(x), mCoordinateTranslater.translateY(y),
            anchorX, anchorY);
    }
     ...
     * No LayoutParams are required; the View will be laid out using WRAP_CONTENT for both width and height,
     * and positioned based on the parameters.
     *
     * @param view    View instance to be added to the TileView.
     * @param x       Relative x position the View instance should be positioned at.
     * @param y       Relative y position the View instance should be positioned at.
     * @param anchorX The x-axis position of a marker will be offset by a number equal to the width of the marker
     *                multiplied by this value.
     * @param anchorY The y-axis position of a marker will be offset by a number equal to the height of the marker
     *                multiplied by this value.
     *
     * @return The View instance added to the TileView.
     */
    public View addMarker(View view, double x, double y, Float anchorX, Float anchorY) {
        return mMarkerLayout.addMarker(view, mCoordinateTranslater.translateX(x), mCoordinateTranslater.translateY(y),
            anchorX, anchorY);
    }
    ...
    /**
     * Returns the CalloutLayout instance used by the TileView to position and display Views used as callouts.
     *
     * @return The CalloutLayout instance.
     */
    public MarkerLayout getCalloutLayout() {
    ...
    /**
     * Returns the CoordinateTranslater instance used by the TileView to manage abritrary coordinate systems.
     *
    ...
    /**
     * Returns the MakerLayout instance used by the TileView to position and display Views used as markers.
     *
    ...
    public void moveMarker(View view, double x, double y) {
        mMarkerLayout.moveMarker(view, mCoordinateTranslater.translateX(x), mCoordinateTranslater.translateY(y));
    }
    ...
    @Override
    public void onPanBegin(int x, int y, String origin) {}
    
    @Override
    public void onPanEnd(int x, int y, String origin) {
        requestRender();
    }
    
    @Override
    public void onPanUpdate(int x, int y, String origin) {}
    ...
    @Override
    public void onZoomBegin(float scale, String origin) {
    
        if (origin.equals(ZoomPanLayout.ZoomPanListener.ORIGINATION_PROGRAMMATIC))
    ...
    @Override
    public void onZoomEnd(float scale, String origin) {
    ...
    @Override
    public void onZoomUpdate(float scale, String origin) {}
    ...
    public void scrollTo(double x, double y) {
        scrollTo(mCoordinateTranslater.translateAndScaleX(x, getScale()),
    ...
    public void scrollToAndCenter(double x, double y) {
        scrollToAndCenter(mCoordinateTranslater.translateAndScaleX(x, getScale()),
            mCoordinateTranslater.translateAndScaleY(y, getScale()));
    }
     ...
     *
     * @param bitmapProvider A class instance that implements BitmapProvider, and must define a getBitmap method,
     *                       which accepts a String file name and a Context object, and returns a Bitmap
     */
    ...
    public void slideTo(double x, double y) {
        slideTo(mCoordinateTranslater.translateAndScaleX(x, getScale()),
            mCoordinateTranslater.translateAndScaleY(y, getScale()));
    }
    ...
    public void slideToAndCenterWithScale(double x, double y, float scale) {
        slideToAndCenterWithScale(mCoordinateTranslater.translateAndScaleX(x, scale),
            mCoordinateTranslater.translateAndScaleY(y, scale), scale);
    }
    ...
    private static class RenderThrottleHandler extends Handler {
        ...
        RenderThrottleHandler(TileView view) {
            super();
            
            mTileViewWeakReference = new WeakReference<>(view);
        ...
        public void handleMessage(Message message) {
            ...
            TileView view = mTileViewWeakReference.get();
            
            if (view != null)
                view.requestSafeRender();
    ...
    private static class SavedState extends BaseSavedState {
        ...
        float mScale;
        int mSavedCenterX, mSavedCenterY;
